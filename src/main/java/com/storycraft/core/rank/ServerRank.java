...
public enum ServerRank {
    ...
    MOD(ChatColor.RED, 3, new String[] { "server.command.*", "server.headdisguise.*", "server.chat.color", "server.spawn.admin.*", "server.play.debug", "minecraft.command.gamemode", "minecraft.command.kick", "minecraft.command.list", "minecraft.command.banlist" }, new String[] { "server.command.ingameconfig", "server.command.ingameplugin", "server.command.rank" }),
    USER(ChatColor.YELLOW, 0, new String[] { "server.play.debug", "server.headdisguise.*", "server.chat.color", "server.command.spawn", "server.command.home", "server.command.sethome", "server.command.randomtp", "server.command.tpa", "server.command.faq" }, new String[] { }),
