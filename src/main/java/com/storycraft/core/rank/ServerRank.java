...
public enum ServerRank {
    ...
    MOD(ChatColor.RED, 3, new String[] { "server.command.*", "server.chat.color", "server.spawn.admin.*", "server.play.debug", "minecraft.command.gamemode", "minecraft.command.kick", "minecraft.command.list", "minecraft.command.banlist" }, new String[] { "server.command.ingameconfig", "server.command.ingameplugin", "server.command.rank" }),
